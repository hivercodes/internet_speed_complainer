...
pw.send_keys(auth[1])
login_button2 = twit.find_element(By.XPATH, '//*[@id="layers"]/div/div/div/div/div/div/div[2]/div[2]/div/div/div[2]/div[2]/div[2]/div/div[1]/div/span/span')
time.sleep(1)
login_button2.click()
...
write.send_keys(f"My internet speed is {dowload} mb down and {upload}. I'm paying for 500 down and 50 up. Is this right?")
